...
#
#     def __init__(self, config_filepath: str, local_source_filepath: str, remote_dest_filepath: str,
#                  server_kill_type: str) -> None:
...
#         self.force_shutdown(self.remote_primary_kill_server_ip)
#
...
#
#         self.remote_primary_kill_server_ip = list(self.hosts_inventory_dict[self.server_kill_type].values())[0]
#
#         if self.server_kill_type == 'client':
#             self.remote_secondary_client_host_ips_list = list(
#                 self.hosts_inventory_dict['client'].values())[1:]
#         else:
#             self.remote_secondary_client_host_ips_list = list(self.hosts_inventory_dict['client'].values())
#
#         return
#
#     # To be ignored. For Testing purpose only.
#     # CLUSTER_1618473912_CHUNKSERVER_2 = "10.0.0.87"
#     # CLUSTER_1618473912_CLIENT_1 = "10.0.0.18"
#     # # CLUSTER_1618469734_CLIENT_2 = "10.0.0.60"
#     # CLUSTER_1618473912_MASTER_1 = "10.0.0.248"
#     # CLUSTER_1618473912_METALOGGER_1 = "10.0.0.107"
# #     def main():
#         # hosts_inventory_dict = {'master': {'CLUSTER_1618469734_MASTER_1': '10.0.0.184'},
#         #                         'metalogger': {'CLUSTER_1618469734_METALOGGER_1': '10.0.0.204'},
#         #                         'chunkserver': {'CLUSTER_1618469734_CHUNKSERVER_2': '10.0.0.80'
#         #                                         },
#         #                         'client': {'CLUSTER_1618469734_CLIENT_1' : "10.0.0.200",
#         #                         'CLUSTER_1618469734_CLIENT_2' = "10.0.0.60"}}
# #
